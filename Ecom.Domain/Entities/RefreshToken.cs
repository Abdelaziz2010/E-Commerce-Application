...
namespace Ecom.Domain.Entities
{
    public class RefreshToken
    {
        ...
        public bool IsExpired => DateTime.UtcNow >= ExpiredAt;      // Track if token expires or not, computed not mapped
        public DateTime? Revoked { get; set; }                      // Track WHEN revocation occurred
        public bool IsActive => Revoked == null && !IsExpired;      // Track if token is active or not, computed not mapped
